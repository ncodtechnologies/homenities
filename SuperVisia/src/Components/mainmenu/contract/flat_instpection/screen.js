    ...
    <Container>
      ...
      <Content contentContainerStyle={{ justifyContent: 'space-around', flex: 1 }}>
        <View style={{ padding: 25 }} > 
          <View>
              <H3>Please provide a suitable date for the inspection </H3>
          </View>
...
export default withFormik({
  mapPropsToValues: ({  token, navigation, reqFlatInspection }) => ({
    id_tenant: 1,
  ...
  handleSubmit: (values, { setSubmitting }) => {
    ...
    return values.reqFlatInspection(formBody);
  }
})(selTime);
