...
import {  Alert, View, TimePickerAndroid, DatePickerAndroid } from 'react-native';
import { Container, Header, Content, Button, Text, Left, Right, Icon, Body, Title, Input, H3, Item } from 'native-base';

export default class LaundryDelivery extends Component {
      ...
      <Container>
        ...
        <Content contentContainerStyle={{ justifyContent: 'space-around', flex: 1 }}>
          <View style={{ padding: 25 }} > 
            <View>
              <H3>Please provide a suitable date and time for Delvery </H3>
            </View>
