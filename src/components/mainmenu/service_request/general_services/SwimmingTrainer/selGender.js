...
export default class selGender extends Component {
  ...
  goToPlans(){
    this.props.navigation.navigate("selSwimmingPlan",{selectedGender : this.state.genders[this.state.gender_id].text, id_company: this.props.navigation.state.params.id_company})
  }
